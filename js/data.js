...
// Changelog data
const CHANGELOG = [
  { date: "21/09/2026", version: "2.4.0", note: "Big usability update contributed by x222: Home is now a Dashboard showing your Prefer/Block lists, projected task-plan rates and Ultimate Slayer progress, with player stats, boosts and persuade unlocks under Setup & settings. Added manual stats entry, saved player profiles, a more reliable player lookup, keyboard and screen reader support, linkable tabs, confirmation before resets, and BLOCKED / EXTENDED BLOCK tags with a single Show excluded toggle. New optional Focus columns toggle hides metrics unrelated to the current sort.", change: "Dashboard, manual stats + accessibility (thanks x222)" },
  { date: "26/02/2026", version: "2.3.1", note: "The Check button is temporarily disabled.", change: "Check button disabled" },
